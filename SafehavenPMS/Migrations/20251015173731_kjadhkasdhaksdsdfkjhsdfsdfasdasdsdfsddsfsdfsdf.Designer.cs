...
namespace SafehavenPMS.Migrations
{
    ...
    [Migration("20251015173731_kjadhkasdhaksdsdfkjhsdfsdfasdasdsdfsddsfsdfsdf")]
    partial class kjadhkasdhaksdsdfkjhsdfsdfasdasdsdfsddsfsdfsdf
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafehavenPMS.Models.ActivityLog", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Audit.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Billable", b =>
                {
                    b.Property<int>("BillableId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BillableId"));
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Billing.BankInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Billing.BillingMonthlyFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AccommodationAmenitiesFee")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("FoodFee")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TreatmentFee")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("Id");

                    b.ToTable("BillingMonthlyFees");
                });

            modelBuilder.Entity("SafehavenPMS.Models.CanteenPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.ClinicalStaff", b =>
                {
                    ...
                    b.Property<string>("ClinicalStaffRefId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Intervention", b =>
                {
                    ...
                    b.Property<string>("DurationFrequency")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Invoice", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.InvoiceLine", b =>
                {
                    ...
                    b.Property<int?>("ReferenceBillableId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.MedicationOrder", b =>
                {
                    ...
                    b.Property<int?>("AdministrationLogId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.MiscellaneousItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Patient", b =>
                {
                    ...
                    b.Property<string>("PatientRefId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.PatientDocument", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.ProgressNote", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.ServiceType", b =>
                {
                    b.Property<int>("ServiceTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SafehavenPMS.Models.User", b =>
                {
            ...
            modelBuilder.Entity("SafehavenPMS.Models.Intervention", b =>
                {
                    ...
                    b.HasOne("SafehavenPMS.Models.PsyProblemList", "Problem")
                        .WithMany("Interventions")
                        .HasForeignKey("PsyProblemListId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SafehavenPMS.Models.Service", "ServiceModality")
                        .WithMany()
            ...
            modelBuilder.Entity("SafehavenPMS.Models.ProgressNote", b =>
                {
                    b.HasOne("SafehavenPMS.Models.Intervention", "Intervention")
